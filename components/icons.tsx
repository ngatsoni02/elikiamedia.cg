...
export const PdfIcon: React.FC<IconProps> = ({ className }) => (
    <svg className={className} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
        <path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8l-6-6zM9.5 13.5c0 .83-.67 1.5-1.5 1.5H7v2H5v-6h3c.83 0 1.5.67 1.5 1.5v1zm-3-2.5H7v1h-.5v-1zm5 5.5h-1v-4h1v4zm4.5-1.5c0 .83-.67 1.5-1.5 1.5h-2.5v-6H15c.83 0 1.5.67 1.5 1.5v3zM15 12h-1.5v1h1.5v-1z" />
    </svg>
);
